...
from utils.web_platform.errors import status
...
class APIException(Exception):
    ...
    def update_detail(self, message=None):
    ...
    def create_info(self, message=None):
        self.info = {
    ...
    def json_info(self):
        return json.json.dumps(self.info, sort_keys=True, ensure_ascii=False)
...
class ValidationError(APIException):
    ...
    def create_info(self, message=None):
        self.info = super(ValidationError, self).create_info(message=message)
        self.info['fields'] = self.fields
